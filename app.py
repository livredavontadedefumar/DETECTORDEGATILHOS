...
def exibir_dashboard_visual(df_aluno):
    ...
    st.info("**O Detector de Gatilhos é uma ferramenta de autoconhecimento e educação comportamental.** As análises são baseadas nas informações fornecidas pelo usuário e não constituem diagnóstico, tratamento médico ou psicológico.")
    st.markdown("---")
